                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="titulos" style="text-align: center;padding: 10px 3%;">
                                            <h3>Formulário Propostas</h3>
                                            <h4 style="color:#575757;">União Apostólica De Famílias Internacional De Schoenstatt</h4>
                                            <p>Todo membro da União de Famílias tem direito a apresentar propostas ou sugestões ao Capítulo Geral, seja individualmente, seja em conjunto com outros membros. As propostas devem ser apresentadas em pelo menos três idiomas (inglês, alemão e espanhol) até 8 de abril de 2021.</p>
                                        </div>
                                            ...
                                            <div class="tab-content twitter-bs-wizard-tab-content">
                                                <div class="tab-pane" id="passo_EN">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5">
                                                            <div class="form-group">
                                                                <label for="autor_EN">Autor(es)</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="titulo_EN">Titulo</label>
                                                                <textarea name="titulo_EN" id="titulo_EN" class="form-control" rows="3"
                                                                    placeholder="Título" required>{{ old('titulo_EN') }}</textarea>
                                                                <div class="valid-feedback">ok!</div>
                                                                <div class="invalid-feedback">Inválido!</div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="texto_EN">Texto</label>
                                                                <textarea name="texto_EN" id="texto_EN" class="form-control" rows="3"
                                                                    placeholder="Texto" required>{{ old('texto_EN') }}</textarea>
                                                                <div class="valid-feedback">ok!</div>
                                                                <div class="invalid-feedback">Inválido!</div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="fundamentacao_EN">Fundamentação</label>
                                                                <textarea name="fundamentacao_EN" id="fundamentacao_EN" class="form-control" rows="3"
                                                                    placeholder="Fundamentação" required>{{ old('fundamentacao_EN') }}</textarea>
                                                                <div class="valid-feedback">ok!</div>
                                                                <div class="invalid-feedback">Inválido!</div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="comentario_EN">Comentário</label>
                                                                <textarea name="comentario_EN" id="comentario_EN" class="form-control" rows="3"
                                                                    placeholder="Comentário" required>{{ old('comentario_EN') }}</textarea>
                                                                <div class="valid-feedback">ok!</div>
                                                                <div class="invalid-feedback">Inválido!</div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="tab-pane" id="passo_DE">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5">
                                                            <div class="form-group">
                                                                <label for="autor_DE">Autor(es)</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="titulo_DE">Titulo</label>
                                                                <textarea name="titulo_DE" id="titulo_DE" class="form-control" rows="3"
                                                                    placeholder="Título" required>{{ old('titulo_DE') }}</textarea>
                                                                <div class="valid-feedback">ok!</div>
                                                                <div class="invalid-feedback">Inválido!</div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="texto_DE">Texto</label>
                                                                <textarea name="texto_DE" id="texto_DE" class="form-control" rows="3"
                                                                    placeholder="Texto" required>{{ old('texto_DE') }}</textarea>
                                                                <div class="valid-feedback">ok!</div>
                                                                <div class="invalid-feedback">Inválido!</div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="fundamentacao_DE">Fundamentação</label>
                                                                <textarea name="fundamentacao_DE" id="fundamentacao_DE" class="form-control" rows="3"
                                                                    placeholder="Fundamentação" required>{{ old('fundamentacao_DE') }}</textarea>
                                                                <div class="valid-feedback">ok!</div>
                                                                <div class="invalid-feedback">Inválido!</div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="comentario_DE">Comentário</label>
                                                                <textarea name="comentario_DE" id="comentario_DE" class="form-control" rows="3"
                                                                    placeholder="Comentário" required>{{ old('comentario_DE') }}</textarea>
                                                                <div class="valid-feedback">ok!</div>
                                                                <div class="invalid-feedback">Inválido!</div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="tab-pane" id="passo_ES">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5">
                                                            <div class="form-group">
                                                                <label for="autor_ES">Autor(es)</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="titulo_ES" id="titulo_ES" class="form-control" rows="3"
                                                                    placeholder="Título" required>{{ old('titulo_ES') }}</textarea>
                                                                <div class="valid-feedback">ok!</div>
                                                                <div class="invalid-feedback">Inválido!</div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="texto_ES">Texto</label>
                                                                <textarea name="texto_ES" id="texto_ES" class="form-control" rows="3"
                                                                    placeholder="Texto" required>{{ old('texto_ES') }}</textarea>
                                                                <div class="valid-feedback">ok!</div>
                                                                <div class="invalid-feedback">Inválido!</div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="fundamentacao_ES">Fundamentação</label>
                                                                <textarea name="fundamentacao_ES" id="fundamentacao_ES" class="form-control" rows="3"
                                                                    placeholder="Fundamentação" required>{{ old('fundamentacao_ES') }}</textarea>
                                                                <div class="valid-feedback">ok!</div>
                                                                <div class="invalid-feedback">Inválido!</div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="comentario_ES">Comentário</label>
                                                                <textarea name="comentario_ES" id="comentario_ES" class="form-control" rows="3"
                                                                    placeholder="Comentário" required>{{ old('comentario_ES') }}</textarea>
                                                                <div class="valid-feedback">ok!</div>
                                                                <div class="invalid-feedback">Inválido!</div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                <label for="email_ES">Email</label>
