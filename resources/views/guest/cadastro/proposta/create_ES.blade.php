...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Formulario Ponencias | FAFIS</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Formulario Ponencias | FAFIS" name="description" />
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="titulos" style="text-align: center;padding: 10px 3%;">
                                            <h3>Formulario Ponencias</h3>
                                            <h4>Federación Apostólica De Familias Internacional De Schoenstatt</h4>
                                            <p style="color:#575757;">Cualquier miembro de la Federación de Familias tiene derecho a presentar mociones y sugerencias al Capítulo General, ya sea individualmente o junto con otros miembros. Las propuestas deben ser presentadas por lo menos en 3 idiomas (inglés, alemán y español) y antes del 8 de abril de 2021.</p>
                                        </div>
                                            ...
                                            <ul class="twitter-bs-wizard-nav nav-justified">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#passo_DE" class="nav-link" data-toggle="tab">
                                                        ...
                                                        <span class="step-title">RESPONDE EN ALEMÁN</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#passo_ES" class="nav-link" data-toggle="tab">
                                                        <span class="step-number">03</span>
                                                        <span class="step-title">RESPONDE EN ESPAÑOL</span>
                                                    </a>
                                                </li>
                                            </ul>
                                            ...
                                            <div class="tab-content twitter-bs-wizard-tab-content">
                                                <div class="tab-pane" id="passo_EN">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="fundamentacao_EN">Fundamentacion</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="comentario_EN">Comentarios</label>
                                                ...
                                                <div class="tab-pane" id="passo_DE">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="titulo_DE">Título</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="fundamentacao_DE">Fundamentacion</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="comentario_DE">Comentarios</label>
                                                ...
                                                <div class="tab-pane" id="passo_ES">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="fundamentacao_ES">Fundamentacion</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="comentario_ES">Comentarios</label>
