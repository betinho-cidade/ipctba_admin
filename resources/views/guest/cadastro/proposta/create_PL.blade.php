...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Wnioski | FAFIS</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Wnioski | FAFIS" name="description" />
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="titulos" style="text-align: center;padding: 10px 3%;">
                                            <h3>Wnioski</h3>
                                            <h4>Międzynarodowa Apostolska Federacja Rodziny Szensztatów</h4>
                                            <p style="color:#575757;">Każdy członek Związku Rodzin ma prawo zgłaszać na Kapitułę Generalną wnioski i sugestie, indywidualnie lub razem z innymi członkami. Wnioski należy składać w co najmniej 3 językach (angielskim, niemieckim i hiszpańskim) do 8 kwietnia 2021 r.</p>
                                        </div>
                                            ...
                                            <div class="tab-content twitter-bs-wizard-tab-content">
                                                <div class="tab-pane" id="passo_EN">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5">
                                                            <div class="form-group">
                                                                <label for="autor_EN">Autorzy</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="titulo_EN">Tytuł</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="texto_EN">Tekst wniosku</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="fundamentacao_EN">Uzasadnienie</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="comentario_EN">Komentarz</label>
                                                ...
                                                <div class="tab-pane" id="passo_DE">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5">
                                                            <div class="form-group">
                                                                <label for="autor_DE">Autorzy</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="titulo_DE">Tytuł</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="texto_DE">Tekst wniosku</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="fundamentacao_DE">Uzasadnienie</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="comentario_DE">Komentarz</label>
                                                ...
                                                <div class="tab-pane" id="passo_ES">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5">
                                                            <div class="form-group">
                                                                <label for="autor_ES">Autorzy</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="titulo_ES">Tytuł</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="texto_ES">Tekst wniosku</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="fundamentacao_ES">Uzasadnienie</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="comentario_ES">Komentarz</label>
