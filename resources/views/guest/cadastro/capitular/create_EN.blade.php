                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="titulos" style="text-align: center;padding: 10px 3%;">
                                            ...
                                            <h4>The Following Are Members Of The General Chapter:</h4>
                                            <p style="color:#575757;">The members of the International Leadership Council - The leader couples of the autonomous territorial Federation communities - Delegate families elected by the autonomous territorial Federation communities (1 couple per territory).</p>
                                            <p>On invitation of the International Leadership Council, couples in territories that are in the foundation process can also attend, as can the leader couple of the previous term of office of the international leadership. They have the right to speak, but not to vote. In 2021 the following territories will be represented by one couple: Costa Rica, Ecuador, Mexico, Czech Republic, and Hungary. In addition to the capitulars many staff and volunteers will be involved: secretaries, technical assistance, translators, house staff etc.</p>
                                        </div>
                                            ...
                                            <div class="tab-content twitter-bs-wizard-tab-content">
                                                <div class="tab-pane" id="passo_EN">
                                                    ...
                                                    <fieldset class="border p-2">
                                                        <legend class="w-auto">WE, AS UNIQUE PERSONS</legend>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="nome_EN">NAMES</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="data_nascimento_EN">BIRTH DATES</label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="profissao_EN">PROFESSIONS</label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="idioma_EN">LANGUAGES SPOKEN</label>
                                                    ...
                                                    <fieldset class="border p-2">
                                                        <legend class="w-auto">WE AS A FAMILY</legend>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="data_casamento_EN">WHEN MARRIED?</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="filho_EN">CHILDREN (Names, Ages)</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="endereco_EN">ADDRESS</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="email_EN">MAIN E-MAIL</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <label for="path_familia_01_EN">Family photo - 01</label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <label for="path_familia_02_EN">Family photo - 02</label>
                                                                <div class="form-group custom-file">
                                                            ...
                                                            <div class="col-md-4">
                                                                <label for="path_familia_03_EN">Family photo - 03</label>
                                                                <div class="form-group custom-file">
                                                    ...
                                                    <fieldset class="border p-2">
                                                        <legend class="w-auto">WE IN SCHOENSTATT</legend>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="data_uniao_familia_EN">WHEN DID WE JOIN FAMILY FEDERATION?</label>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="ano_consagracao_EN">YEAR OF PERPETUAL CONSECRATION</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="santuario_EN">HOME SHRINE</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="apostolado_EN">APOSTOLATE</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="desejo_casal_EN">OUR DESIRE AS COUPLE</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="palavra_EN">THREE WORDS THAT IDENTIFY US</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="frase_EN">OUR INSPIRING PHRASE</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="expectativa_EN">OUR EXPECTATION FOR THE CHAPTER</label>
                                                ...
                                                <div class="tab-pane" id="passo_DE">
                                                    ...
                                                    <fieldset class="border p-2">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="profissao_DE">PROFESSIONS</label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="idioma_DE">LANGUAGES SPOKEN</label>
                                                    ...
                                                    <fieldset class="border p-2">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="data_casamento_DE">WHEN MARRIED?</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="filho_DE">CHILDREN (Names, Ages)</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="endereco_DE">ADDRESS</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="email_DE">MAIN E-MAIL</label>
                                                    ...
                                                    <fieldset class="border p-2">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="data_uniao_familia_DE">WHEN DID WE JOIN FAMILY FEDERATION?</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="curso_DE">COURSE</label>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="ano_consagracao_DE">YEAR OF PERPETUAL CONSECRATION</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="santuario_DE">HOME SHRINE</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="apostolado_DE">APOSTOLATE</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="desejo_casal_DE">OUR DESIRE AS COUPLE</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="palavra_DE">THREE WORDS THAT IDENTIFY US</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="frase_DE">OUR INSPIRING PHRASE</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="expectativa_DE">OUR EXPECTATION FOR THE CHAPTER</label>
                                                ...
                                                <div class="tab-pane" id="passo_ES">
                                                    ...
                                                    <fieldset class="border p-2">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="profissao_ES">PROFESSIONS</label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="idioma_ES">LANGUAGES SPOKEN</label>
                                                    ...
                                                    <fieldset class="border p-2">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="data_casamento_ES">WHEN MARRIED?</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="filho_ES">CHILDREN (Names, Ages)</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="endereco_ES">ADDRESS</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="email_ES">MAIN E-MAIL</label>
                                                    ...
                                                    <fieldset class="border p-2">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="data_uniao_familia_ES">WHEN DID WE JOIN FAMILY FEDERATION?</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="curso_ES">COURSE</label>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="ano_consagracao_ES">YEAR OF PERPETUAL CONSECRATION</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="santuario_ES">HOME SHRINE</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="apostolado_ES">APOSTOLATE</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="desejo_casal_ES">OUR DESIRE AS COUPLE</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="palavra_ES">THREE WORDS THAT IDENTIFY US</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="frase_ES">OUR INSPIRING PHRASE</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="expectativa_ES">OUR EXPECTATION FOR THE CHAPTER</label>
