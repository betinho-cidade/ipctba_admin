...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Formulario Participantes | FAFIS</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Formulario Participantes | FAFIS" name="description" />
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="titulos" style="text-align: center;padding: 10px 3%;">
                                            <h3>Formulario Participantes</h3>
                                            <h4 style="color:#575757;">Son Miembros Del Capítulo General:</h4>
                                            <p>Los matrimonios de la Dirección Internacional - Los matrimonios jefes de las Federaciones territoriales autónomas - Los matrimonios delegados elegidos por las Federaciones territoriales autónomas (un matrimonio por territorio).</p>
                                            <p>Por invitación de la Dirección Internacional, también podrán participar el matrimonio jefe del último período de la Dirección Internacional y matrimonios de territorios en formación tras consulta con los encargados de fundación. Tendrán derecho a voz pero sin voto. En el Capitulo General de 2021 serán representados por un matrimonio los territorios siguientes: Costa Rica, Ecuador, México, Rep. Checa y Hungría. Además de los capitulares, contribuyen muchos colaboradores y voluntarios al Capítulo: secretarios, personal técnico, traductores, personal de casa, etc. Los nombres de los capitulares serán anunciados aquí en una fecha posterior.</p>
                                        </div>
                                            ...
                                            <ul class="twitter-bs-wizard-nav nav-justified">
                                                <li class="nav-item">
                                                    <a href="#passo_EN" class="nav-link" data-toggle="tab">
                                                        ...
                                                        <span class="step-title">RESPONDE EN INGLÉS</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#passo_DE" class="nav-link" data-toggle="tab">
                                                        <span class="step-number">02</span>
                                                        <span class="step-title">RESPONDER EN ALEMÁN</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#passo_ES" class="nav-link" data-toggle="tab">
                                                        <span class="step-number">03</span>
                                                        <span class="step-title">RESPONDER EN ESPAÑOL</span>
                                                    </a>
                                                </li>
                                            </ul>
                                            ...
                                            <div class="tab-content twitter-bs-wizard-tab-content">
                                                <div class="tab-pane" id="passo_EN">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="paise_EN">TERRITORIO</label>
                                                    ...
                                                    <fieldset class="border p-2">
                                                        <legend class="w-auto">NOSOTROS, COMO PERSONAS</legend>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="nome_EN">NOMBRES</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="celular_EN">NUMEROS DE CELULARES (WHATSAPP)</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="data_nascimento_EN">FECHAS DE NACIMIENTO</label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="profissao_EN">PROFESIONES</label>
                                                    ...
                                                    <fieldset class="border p-2">
                                                        <legend class="w-auto">NOSOTROS COMO FAMÍLIA</legend>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="data_casamento_EN">FECHA DE CASAMIENTO</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="filho_EN">HIJOS (Nombres, Edades)</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="endereco_EN">DIRECCIÓN</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="email_EN">CORREO ELECTRÓNICO PRINCIPAL</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <label for="path_familia_01_EN">Foto de familia - 01</label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <label for="path_familia_02_EN">Foto de familia - 02</label>
                                                                <div class="form-group custom-file">
                                                            ...
                                                            <div class="col-md-4">
                                                                <label for="path_familia_03_EN">Foto de familia - 03</label>
                                                                <div class="form-group custom-file">
                                                    ...
                                                    <fieldset class="border p-2">
                                                        <legend class="w-auto">NOSOTROS EN SCHOENSTATT</legend>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="data_uniao_familia_EN">FECHA DE INICIO EN FEDERACIÓN APOSTOLICAS DE FAMILIAS</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="ideal_curso_EN">IDEAL DEL CURSO</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="ano_consagracao_EN">FECHA DE CONSAGRACIÓN PERPETUA</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="santuario_EN">IDEAL Y FECHA DE BENDICIÓN DE SANTUARIO HOGAR</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="apostolado_EN">APOSTOLADOS</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="desejo_casal_EN">NUESTRO DESEO COMO MATRIMONIO</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="palavra_EN">TRES PALABRAS QUE NOS IDENTIFICAN</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="frase_EN">NUESTRA FRASE INSPIRADORA</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="expectativa_EN">NUESTRA EXPECTATIVA PARA EL CAPÍTULO</label>
                                                ...
                                                <div class="tab-pane" id="passo_DE">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="paise_DE">TERRITORIO</label>
                                                    ...
                                                    <fieldset class="border p-2">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="nome_DE">NOMBRES</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="celular_DE">NUMEROS DE CELULARES (WHATSAPP)</label>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="profissao_DE">PROFESIONES</label>
                                                    ...
                                                    <fieldset class="border p-2">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="data_casamento_DE">FECHA DE CASAMIENTO</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="filho_DE">HIJOS (Nombres, Edades)</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="endereco_DE">DIRECCIÓN</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="email_DE">CORREO ELECTRÓNICO PRINCIPAL</label>
                                                    ...
                                                    <fieldset class="border p-2">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="data_uniao_familia_DE">FECHA DE INICIO EN FEDERACIÓN APOSTOLICAS DE FAMILIAS</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="ideal_curso_DE">IDEAL DEL CURSO</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="ano_consagracao_DE">FECHA DE CONSAGRACIÓN PERPETUA</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="santuario_DE">IDEAL Y FECHA DE BENDICIÓN DE SANTUARIO HOGAR</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="apostolado_DE">APOSTOLADOS</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="desejo_casal_DE">NUESTRO DESEO COMO MATRIMONIO</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="palavra_DE">TRES PALABRAS QUE NOS IDENTIFICAN</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="frase_DE">NUESTRA FRASE INSPIRADORA</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="expectativa_DE">NUESTRA EXPECTATIVA PARA EL CAPÍTULO</label>
                                                ...
                                                <div class="tab-pane" id="passo_ES">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="paise_ES">TERRITORIO</label>
                                                    ...
                                                    <fieldset class="border p-2">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="nome_ES">NOMBRES</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="celular_ES">NUMEROS DE CELULARES (WHATSAPP)</label>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="profissao_ES">PROFESIONES</label>
                                                    ...
                                                    <fieldset class="border p-2">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="data_casamento_ES">FECHA DE CASAMIENTO</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="filho_ES">HIJOS (Nombres, Edades)</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="endereco_ES">DIRECCIÓN</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="email_ES">CORREO ELECTRÓNICO PRINCIPAL</label>
                                                    ...
                                                    <fieldset class="border p-2">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="data_uniao_familia_ES">FECHA DE INICIO EN FEDERACIÓN APOSTOLICAS DE FAMILIAS</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="ideal_curso_ES">IDEAL DEL CURSO</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="ano_consagracao_ES">FECHA DE CONSAGRACIÓN PERPETUA</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="santuario_ES">IDEAL Y FECHA DE BENDICIÓN DE SANTUARIO HOGAR</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="apostolado_ES">APOSTOLADOS</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="desejo_casal_ES">NUESTRO DESEO COMO MATRIMONIO</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="palavra_ES">TRES PALABRAS QUE NOS IDENTIFICAN</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="frase_ES">NUESTRA FRASE INSPIRADORA</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="expectativa_ES">NUESTRA EXPECTATIVA PARA EL CAPÍTULO</label>
