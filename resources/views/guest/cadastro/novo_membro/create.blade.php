                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="igreja_old_pastor_email" name="igreja_old_pastor_email" value="{{old('igreja_old_pastor_email')}}" placeholder="Email Pastor">
                                        <div class="valid-feedback">ok!</div>
                                        <div class="invalid-feedback">Inválido!</div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mask_celular" id="igreja_old_pastor_fone" name="igreja_old_pastor_fone" value="{{old('igreja_old_pastor_fone')}}" placeholder="(99) 99999-9999">
                                        <div class="valid-feedback">ok!</div>
                                        <div class="invalid-feedback">Inválido!</div>
                                    </div>
                                </div>                                
