...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Ofícios</h4>

            <div class="page-title-right">
                <a href="{{route("oficio.create")}}" class="btn btn-outline-secondary waves-effect">Novo Ofício</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title">Listagem dos Ofícios do Sistema</h4>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#ativa" role="tab">
                            ...
                            <span class="d-none d-sm-block">Ofícios ( <code class="highlighter-rouge">{{$oficios->count()}}</code> )</span>
                        </a>
                    </li>
                </ul>
                <!-- Nav tabs - LISTA - FIM -->
                ...
                <div class="tab-pane active" id="ativa" role="tabpanel">
                    <table id="dt_oficios" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        <thead>
                        <tr>
                            <th>ID</th>
                            <th>Nome</th>
                        ...
                        <tr>
                            ...
                            @can('edit_oficio')
                                <a href="{{route('oficio.show', compact('oficio'))}}"><i class="fa fa-edit" style="color: goldenrod" title="Editar o Ofício"></i></a>
                            @endcan

                            @can('delete_oficio')
                                <a href="javascript:;" data-toggle="modal" onclick="deleteData({{$oficio->id}})"
                                    data-target="#modal-delete-oficio"><i class="fa fa-minus-circle" style="color: crimson" title="Excluir o Ofício"></i></a>
                                    ...
                                    @section('modal_name')"modal-delete-oficio"@endsection
...
@section('script-js')
   ...
   <!-- Datatable init js -->
    ...
    @if($oficios->count() > 0)
        <script>
            var table_AT = $('#dt_oficios').DataTable({
                language: {
    ...
    <script>
       ...
       {
           var id = id;
           var url = '{{ route("oficio.destroy", ":id") }}';
