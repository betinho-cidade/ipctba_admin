...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Ministérios</h4>

            <div class="page-title-right">
                <a href="{{route("ministerio.create")}}" class="btn btn-outline-secondary waves-effect">Novo Ministério</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title">Listagem dos Ministérios do Sistema</h4>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#ativa" role="tab">
                            ...
                            <span class="d-none d-sm-block">Ministérios ( <code class="highlighter-rouge">{{$ministerios->count()}}</code> )</span>
                        </a>
                    </li>
                </ul>
                <!-- Nav tabs - LISTA - FIM -->
                ...
                <div class="tab-pane active" id="ativa" role="tabpanel">
                    <table id="dt_ministerios" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        <thead>
                        <tr>
                            <th>ID</th>
                            <th>Nome</th>
                        ...
                        <tr>
                            ...
                            @can('edit_ministerio')
                                <a href="{{route('ministerio.show', compact('ministerio'))}}"><i class="fa fa-edit" style="color: goldenrod" title="Editar o Ministério"></i></a>
                            @endcan

                            @can('delete_ministerio')
                                <a href="javascript:;" data-toggle="modal" onclick="deleteData({{$ministerio->id}})"
                                    data-target="#modal-delete-ministerio"><i class="fa fa-minus-circle" style="color: crimson" title="Excluir o Ministério"></i></a>
                                    ...
                                    @section('modal_name')"modal-delete-ministerio"@endsection
...
@section('script-js')
   ...
   <!-- Datatable init js -->
    ...
    @if($ministerios->count() > 0)
        <script>
            var table_AT = $('#dt_ministerios').DataTable({
                language: {
    ...
    <script>
       ...
       {
           var id = id;
           var url = '{{ route("ministerio.destroy", ":id") }}';
