...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Informações do Histórico da Situação do Membro</h4>
        </div>
    </div>
</div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="oficio">Situação do Membro</label>
                                <input type="text" disabled class="form-control" value="{{$historico_situacao->situacao_membro->nome}}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="data_inicio">Data Início</label>
                                <input type="date" disabled class="form-control" value="{{$historico_situacao->data_inicio_ajustada}}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="data_fim">Data Fim</label>
                                <input type="date" class="form-control" id="data_fim" name="data_fim" value="{{$historico_situacao->data_fim_ajustada}}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="3" id="comentario" name="comentario" placeholder="Comentários...">{{ $historico_situacao->comentario }}</textarea>
                                <div class="valid-feedback">ok!</div>
                                <div class="invalid-feedback">Inválido!</div>
                            </div>
                        </div>
