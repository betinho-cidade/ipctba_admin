                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="data_solicitacao" name="data_solicitacao" value="{{old('data_solicitacao')}}" required>
                                <div class="valid-feedback">ok!</div>
                                <div class="invalid-feedback">Inválido!</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="data_realizacao" name="data_realizacao" value="{{old('data_realizacao')}}">
                                <div class="valid-feedback">ok!</div>
                                <div class="invalid-feedback">Inválido!</div>
                            </div>
                        </div>
